...
-- 4. Give the name of the 'peace' winners since the
--    year 2000, including 2000.
SELECT winner
FROM nobel
WHERE
    subject = 'peace'
...
--        ex: WHERE winner = 'eugene o\'neill'
...
-- 14. The expression subject IN ('chemistry','physics') can
--     be used as a value - it will be 0 or 1.
